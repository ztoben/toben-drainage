    ...
    return (
      <div id="about">
        <div className="about-text">
          ...
          <p>
            In 2010 we purchased our first commercial Wolfe plow, and we most recently upgraded to a
            Wolfe PL540. Toben Drainage performs precision farm tiling using GPS technology, as well
            as commercial and residential drainage for new and existing construction.
          </p>
